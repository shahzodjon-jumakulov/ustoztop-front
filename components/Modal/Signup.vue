      ...
      <div class="flex justify-center items-center w-full h-full fixed">
        ...
        >
          <div
            ...
            @click="(auth = false), (isSelected = null)"
          >
            <svg
              class="group cursor-pointer p-0.5"
          ...
          <div class="flex flex-col text-center w-full h-full gap-8">
            <div class="flex items-center justify-center">
              <div
                class="ml-auto md:hidden absolute left-5"
                @click="(auth = false), (isSelected = null)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div class="px-2.5 py-1.5">
                    ...
                    >
                      <path
                        ...
                        fill="#787B8D"
                        class="group-[.selected]:fill-blue"
                      />
                    </svg>
                  </div>
                  <div class="text-gray text-base group-[.selected]:text-black">
            ...
            <div
              class="flex justify-center items-center gap-[5px] text-sm pb-4"
            >
