<template>
    <div class="fixed w-full h-full flex bg-white overflow-auto justify-center">
        <div class="flex flex-col w-[320px]">
            ...
            <div class="flex flex-col w-[320px] p-4">
                <div class="flex flex-col gap-[32px]">
                    <div class="flex flex-col self-stretch xl:min-w-[352px] lg:min-w-[267px]">
                        ...
                        <button class="py-[15px] px-2.5 flex self-stretch items-center text-[14px] gap-2.5 text-gray">
                    ...
                    <div class="flex flex-col gap-[15px]">
                        ...
                        <form class="flex flex-row justify-center items-stretch gap-2.5">
                            <div class="flex items-center rounded-[200px] w-[139px] px-5 py-3 gap-[3px] bg-bg">
                                <label for="min_price" class="text-gray text-[12px]">от</label>
                                <input id="min_price"
                                    class="bg-bg outline-none w-[83px] text-black text-[14px] font-bold placeholder:text-black placeholder:text[14px] placeholder:font-bold"
