...
<template>
    <teleport to="body">
        <div class="fixed inset-0 z-[9] h-[100svh]" v-if="auth">
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex w-full">
                        <div v-if="isLogin != 0" class="group/icon mr-auto hidden md:block cursor-pointer" @click="isLogin--">
                        ...
                        <div class="group/icon ml-auto hidden md:block cursor-pointer" @click="auth = false, isSelected = null">
                    ...
                    <div v-if="isLogin == 0" class="flex flex-col text-center w-full h-full gap-8 md:gap-5">
                    ...
                    <div v-else-if="isLogin == 1" class="flex flex-col text-center w-full h-full gap-8 md:gap-5">
                        ...
                        <BaseButton @click="isLogin = 2" type="primary" size="large">
                            {{ $t("submit") }}
                        </BaseButton>
                    </div>
