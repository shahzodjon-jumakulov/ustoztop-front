...
<template>
    <div
        ...
        <div class="navbar hidden lg:flex items-center">
            ...
            <!-- profile -->
            <div v-else
                class="group/avatar relative p-[1px] border border-bg rounded-full cursor-pointer hover:border-blue active:border-pressed w-[50px] h-[50px] select-none">
                <NuxtLink :to="localePath('/profile')" class="group/icon">
                    <svg v-if="userInfo.profile_pic" xmlns="http://www.w3.org/2000/svg" width="46" height="46"
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            fill="#787B8D" class="fill-icon group-hover/icon:fill-blue group-active/icon:fill-pressed" />
                    </svg>
                    <div class="" v-else>
                    ...
                    <div
                        ...
                        <div class="flex gap-2.5 items-center p-2.5">
                            ...
                            <div class="flex flex-col gap-[5px]">
                                ...
                                <div v-if="userInfo.role == 'TUTOR'" class="flex gap-0.5 items-center text-xs text-gray">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                        fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div
                            class="group/icon px-2.5 flex gap-2.5 items-center hover:bg-bg active:bg-bg2 rounded-[200px] h-[34px]">
                            ...
                            <span class="rounded-3xl bg-bg2 h-6 flex items-center px-2 text-xs">19</span>
                        </div>
                        <div
                            class="group/icon px-2.5 flex gap-2.5 items-center hover:bg-bg active:bg-bg2 rounded-[200px] h-[34px]">
                            <div class="w-[18px] h-[18px] flex items-center justify-center">
                        ...
                        <div @click="isLogout = true"
                            class="group/icon px-2.5 flex gap-2.5 items-center hover:bg-[#FCEBEF] active:bg-[#FAD6DF] rounded-[200px] h-[34px]">
                            <div class="w-[18px] h-[18px] flex items-center justify-center">
